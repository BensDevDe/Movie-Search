...
async function searchMovies(search) {
  try {
    const movie = await (
      await fetch(`https://www.omdbapi.com/?apikey=871fc2a6&s=${search}`)
    ).json()
    ...
    movie.Search.map((element) => {
      ...
      button.addEventListener('click', () => {
        ...
        movieObject.then((data) => {
          ...
          document.body.style.backgroundImage = `linear-gradient(rgba(97, 97, 97, 0.5), rgba(0, 0, 0, 0.9)),url("${
          ...
          movieDetail.innerHTML = `
                ...
                <p> <span> ${Object.keys(data)[1]} </span> : ${
            Object.values(data)[1]
          } </p>
                <p> <span> ${Object.keys(data)[2]} </span> : ${
            Object.values(data)[2]
          } </p>
                <p> <span> ${Object.keys(data)[3]} </span> : ${
            Object.values(data)[3]
          } </p>
                <p> <span> ${Object.keys(data)[4]} </span> : ${
            Object.values(data)[4]
          } </p>
                <p> <span> ${Object.keys(data)[5]} </span> : ${
            Object.values(data)[5]
          } </p>
                <p> <span> ${Object.keys(data)[6]} </span> : ${
            Object.values(data)[6]
          } </p>
                <p> <span> ${Object.keys(data)[7]} </span> : ${
            Object.values(data)[7]
          } </p>
                <p> <span> ${Object.keys(data)[8]} </span> : ${
            Object.values(data)[8]
          } </p>
                <p> <span> ${Object.keys(data)[9]} </span> : ${
            Object.values(data)[9]
          } </p>
                <p> <span> ${Object.keys(data)[10]} </span> : ${
            Object.values(data)[10]
          } </p>
                <p> <span> ${Object.keys(data)[11]} </span> : ${
            Object.values(data)[11]
          } </p>
                <p> <span> ${Object.keys(data)[12]} </span> : ${
            Object.values(data)[12]
          } </p>
                <p> <span> ${Object.keys(data)[19]} </span> : ${
            Object.values(data)[19]
          } </p>
                <p> <span> ${Object.keys(data)[20]} </span> : ${
            Object.values(data)[20]
          } </p>
                <p> <span> ${Object.keys(data)[21]} </span> : ${
            Object.values(data)[21]
          } </p>
...
async function getMovieDetail(movieId) {
  try {
    const movie = await (
      await fetch(`https://www.omdbapi.com/?apikey=871fc2a6&i=${movieId}`)
    ).json()
    return movie
  } catch (error) {
    console.log(error.message)
